...
#for scene in ["stairs"]:
    ...
    Model.load_ply(f"D:/gs-localization/output/7scenes_dslam/{scene}/gs_map/iteration_30000/point_cloud.ply")
    ...
    with open(f"D:/gs-localization/output/7scenes_dslam/{scene}/results_dense.txt", "r") as f:
        for line in f:
    ...
    file = h5py.File(f'D:/gs-localization/output/7scenes_dslam/{scene}/feats-superpoint-n4096-r1024.h5', 'r')
    ...
    np.save(f"D:/gs-localization/output/7scenes_dslam/{scene}/rot_errors.npy", rot_errors)
    np.save(f"D:/gs-localization/output/7scenes_dslam/{scene}/trans_errors.npy", trans_errors)
