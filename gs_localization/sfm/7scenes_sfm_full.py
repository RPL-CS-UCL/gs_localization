...
from hloc.utils.sfm_utils import create_query_list_with_intrinsics, correct_sfm_with_gt_depth
...
def run_scene(
    ...
    create_query_list_with_intrinsics(gt_dir, gt_dir, query_list, test_list, ext=".txt")
...
if __name__ == "__main__":
    ...
    for scene in args.scenes:
        ...
        #if scene == "stairs": args.num_retrieve = 10
        ...
        if args.overwrite or True:
            run_scene(
                ...
                results,
                args.dataset / scene / "depths_full",
                args.num_covis,
                args.num_retrieve
                )
