...
def run_scene(
    ...
    train_list = input / "train_full.txt"
    test_list = input / "test_full.txt"
    ...
    for scene in args.scenes:
        ...
        if args.overwrite or True:
            run_scene(
                args.dataset / scene,
                args.outputs / scene,
                args.dataset / scene / "images_full",
        ...
        list_file = args.dataset / scene / "test_full.txt"
        model = f"D:/gs-localization/datasets/cambridge/CambridgeLandmarks_Colmap_Retriangulated_1024px/{scene}/empty_all"
