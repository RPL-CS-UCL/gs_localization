...
def copy_images_and_setup_sfm(dataset, outputs, scene):
    ...
    images_src_dir = Path(dataset) / scene / 'train_images'
    images_dst_dir = Path(outputs) / scene / 'images'
    sfm_src_dir = Path(outputs) / scene / 'sfm_sift'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--outputs",
        type=Path,
        default=Path(__file__).resolve().parent.parent.parent/"output/cambridge",
