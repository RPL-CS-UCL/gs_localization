...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[7_000, 15_000, 20_000, 25_000, 27_500, 30_000])
    ...
    args.source_path = Path("E:/lab/views")
    args.model_path = Path("E:/lab/views")
