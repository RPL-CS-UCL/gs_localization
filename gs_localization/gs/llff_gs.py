...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        type=Path,
        default=Path(__file__).resolve().parent.parent.parent/"datasets/nerf_llff_data",
        help="Path to the dataset, default: %(default)s",
    )
    parser.add_argument(
        "--outputs",
        type=Path,
        default=Path(__file__).resolve().parent.parent.parent/"output/nerf_llff_data",
    ...
    for scene in SCENES:
        ...
        training(lp.extract(args), 
                    op.extract(args), 
                    pp.extract(args), 
                    [7_000, 20_000, 25_000, 27_500, 30_000], 
                    [7_000, 30_000], 
