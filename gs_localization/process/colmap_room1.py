...
def pipeline(scene, base_path):
    ...
    # Perform feature extraction with specified camera model as PINHOLE, with 8192 features
    ...
    # Perform matching with GPU acceleration
    os.system('colmap exhaustive_matcher --database_path database.db --SiftMatching.guided_matching=1 --SiftMatching.max_num_matches=8192 --SiftMatching.use_gpu=1')
    ...
    # Convert bin files to txt format in the sparse folder
...
pipeline(scene='lab', base_path='E:/')
