...
def pipeline(scene, base_path):
    ...
    os.system(f'colmap model_converter --input_path D:/visloc_pseudo_gt_limitations/7scenes_reference_models/{scene}/old_gt_triangulated --output_path sparse_dslam/0/ --output_type TXT')

    with open('sparse_dslam/0/images.txt', "r") as fid:
        lines = fid.readlines()
    ...
    with open('sparse_dslam/0/images.txt', "w") as fid:
